...
class categoryproductcontroller extends Controller
{
    ...
    {
        $raucuqua = product::where('category_id', 2)->orderBy('id', 'DESC')->get();
        $douonggiaikhat = product::where('category_id', 3)->orderBy('id', 'DESC')->get();
        $thucphamtuoisong = product::where('category_id', 1)->orderBy('id', 'DESC')->get();
        $bosuutapmoi = product::orderBy('id', 'DESC')->take(20)->get();
        $thucphamanlien = product::where('category_id', 5)->orderBy('id', 'DESC')->get();
