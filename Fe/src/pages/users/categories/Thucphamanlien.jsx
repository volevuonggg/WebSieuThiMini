        ...
        <div className="category-container">
          ...
          <div className="category-content">
            <div className="category-banner">
              <img src={bannerImage || "/placeholder.svg"} alt="Banner thực phẩm ăn liền" className="banner-image" />
                ...
                <div className="home-product-card" key={cate.id}>
                  ...
                  <div className="home-product-info">
                    ...
                    <div className="home-product-price">
                      {cate.gia}đ{cate.discount && <span className="product-price-original">39.000₫</span>}
                    </div>
